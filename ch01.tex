...
\begin{ex}[maximal independent sets]
    ...
    \begin{subex}
        \item\label{subex:intro-mis-a} a deterministic algorithm that uses unique unique identifiers,
        \item\label{subex:intro-mis-b} a fast deterministic algorithm that uses $128$-bit unique identifiers,

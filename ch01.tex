...
\section{Algorithm \talgo{P3C}: Colouring with Unique Identifiers}\label{sec:algo-p3c}
...
\section{Algorithm \talgo{P3CBit}: Fast Colouring with Unique Identifiers}\label{sec:algo-p3cbit}
...
\section{Algorithm \talgo{P3CRand}: Exploiting Randomness}\label{sec:algo-p3crand}

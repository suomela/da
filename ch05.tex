...
\section{Algorithm \talgo{BDGreedy}: Colour Reduction in Bounded-Degree Graphs}\label{sec:bdgreedy}
...
\section{Algorithm \talgo{DPGreedy}: Colour Reduction in Directed Pseudoforests}\label{sec:dpgreedy}
...
\section{Algorithm \talgo{DPBit}: Fast Colour Reduction in Directed Pseudoforests}\label{sec:dpbit}
...
\section{Algorithm \talgo{DP3C}: Fast 3-Colouring in Directed Pseudoforests}\label{sec:dp3c}
...
\section{Algorithm \talgo{BDColour}: Fast Colouring in Bounded-Degree Graphs}\label{sec:bdcolour}
